...
const url = 'https://www.hyunsukerickson.art/paintings'
let linkList = []
let dlinkList = []
...
const downloadLinks = async (linkList) => {
  ...
  for (const link of linkList) {
    ...
    const writer = fs.createWriteStream("C:\\Users\\perso\\Desktop\\Website\\HyunsukErickson\\HyunsukErickson\\assets\\img\\paintings\\" + count + ".jpeg");
